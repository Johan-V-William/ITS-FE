...
export const SignIn = ({ onSwitchToSignUp }: SignInProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setApiError((error as Error).message || 'Login failed. Please try again.');
    }
  };
  ...
  return (
    <div className=" bg-white rounded-3xl mb-16 mr-[40rem] shadow-xl p-8 w-full max-w-md relative z-10">
      <div className="mb-8">
        ...
        <h1 className="text-6xl font-bold text-gray-900 text-left ">Sign in</h1>
      </div>
      ...
      <div className="text-left">
        ...
        <div className="flex gap-3">
          ...
          <SocialButton icon={<AppleIcon />} onClick={() => console.log('Apple')} />
        </div>
      </div>
    </div>
  );
