...
import { ArrowDown, ArrowUp, ChevronLeft, ChevronRight, List, TrendingDown, TrendingUp, Users } from 'lucide-react';
import  examApi from '../api/examApi';
import { useQuiz } from '../hooks/useQuiz';
import type { QuizResultsData } from '../types/types';
...
const ResultsPage: React.FC<ResultsPageProps> = ({ quizId }) => {
  ...
  useEffect(() => {
    examApi.getQuizResults(quizId).then(setResults);
  }, [quizId]);
